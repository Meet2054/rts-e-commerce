			...
			<div className="flex flex-col lg:flex-row max-w-[1550px] mx-auto px-4 sm:px-6 md:px-10 lg:px-14 xl:px-16 py-6">
				<div className='flex flex-col w-full'>
					<div className="flex items-center justify-between mb-4">
						<h2 className="text-xl md:text-2xl pl-3 font-bold border-l-8 border-[#2E318E] p-0.5 text-black">Previous Orders</h2>
					</div>
			...
			<div className="flex flex-col lg:flex-row max-w-[1550px] mx-auto px-4 sm:px-6 md:px-10 lg:px-14 xl:px-16 py-6">
				<div className='flex flex-col w-full'>
					...
					<div className="text-center py-12">
						<p className="text-gray-600 text-xl mb-2">No previous orders found</p>
					</div>
				</div>
			</div>
		);
