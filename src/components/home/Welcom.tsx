...
const Welcom = () => {
	const { user, userData, loading } = useAuth();
		...
		if (loading) {
			return (
				<div className="max-w-[1550px] mx-auto px-4 sm:px-6 md:px-10 lg:px-14 xl:px-16 py-8">
		...
		return (
			<div className="max-w-[1550px] mx-auto px-4 sm:px-6 md:px-10 lg:px-14 xl:px-16 flex flex-col gap-6 py-3">
				{/* Logged-in Welcome */}
				{user && (
